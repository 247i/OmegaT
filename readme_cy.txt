...
union un strwythur, gan gynnwys cop�au o ffeiliau sydd ddim yn cael eu cynnal.
...
*Defnyddwyr Mac:
Cop�wch yr archif OmegaT.zip i leoliad addas a'i ddadbacio er mwyn cael
ffolder sy'n cynnwys ffeil mynegai dogfen HTML ac OmegaT.app,
y ffeil rhaglen. 

*Eraill (e.e. Solaris, FreeBSD):
I osod OmegaT cr�wch ffolder addas ar gyfer OmegaT. Cop�wch archif  zip neu tar.gz OmegaT i'r ffolder yma a'i ddadbacio.
...
Gallwch ychwanegu cop�au o ffeiliau, darnau o'r log, lluniau sgrin, unrhyw beth rydych yn ei feddwl bydd o gymorth i'r datblygwyr i ganfod a chywiro eich gwall.
