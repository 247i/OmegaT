...
OmegaT使用了许多库。各个库的许可证在以下文件中有所提及：
...
你可以将 OmegaT 应用程序拖动到程序坞（dock）面板或访达（Finder）窗口的工具栏
以便从任意位置启动它。您还可以从聚焦搜索（Spotlight search）的搜索区中启动它。
...
如果您用了 linux-install.sh 脚本，应当可以这样启动 OmegaT：
...
Jean-Christophe Helary 是 OmegaT 的项目经理。
